...
$zhlCommon = [
    'de_de' => [
        ...
        'ZhlAccountCertAvailableHead' => 'Diese Einführungen können Sie noch erwerben',
        'ZhlAccountCertAvailableHint' => 'Vereinbaren Sie einfach einen Einführungstermin — nach absolvierter Einführung wird das Zertifikat freigeschaltet und Sie buchen diese Geräte künftig ohne weiteren Einführungstermin.',
        'ZhlAccountCertRequest'   => 'Einführungstermin anfragen',
        'ZhlAccountCertRenew'     => 'Einführung erneuern — Termin anfragen',
        'ZhlAccountCertBadgeAvailable' => 'erwerbbar',
    ...
    'en_us' => [
        ...
        'ZhlAccountCertAvailableHead' => 'Inductions you can still complete',
        'ZhlAccountCertAvailableHint' => 'Simply request an induction appointment — once completed, the certificate is granted and you can book these devices without another induction appointment.',
        'ZhlAccountCertRequest'   => 'Request induction appointment',
        'ZhlAccountCertRenew'     => 'Renew induction — request appointment',
        'ZhlAccountCertBadgeAvailable' => 'available',
